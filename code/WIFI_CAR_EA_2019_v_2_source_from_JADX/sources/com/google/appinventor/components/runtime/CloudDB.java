...
public final class CloudDB extends AndroidNonvisibleComponent implements Component, OnClearListener, OnDestroyListener {
    ...
    /* renamed from: com.google.appinventor.components.runtime.CloudDB$1 */
    class C02201 extends Thread {
        C02201() {
        }
    ...
    /* renamed from: com.google.appinventor.components.runtime.CloudDB$2 */
    ...
    /* renamed from: com.google.appinventor.components.runtime.CloudDB$8 */
        ...
        if (isConnected) {
            synchronized (this.storeQueue) {
                ...
                try {
                    ...
                    if (kickit) {
                        this.background.submit(new C02212());
                    }
    ...
    public void GetValue(final String tag, final Object valueIfTagNotThere) {
        ...
        if (isConnected) {
            this.background.submit(new Runnable() {
                ...
                /* renamed from: com.google.appinventor.components.runtime.CloudDB$3$1 */
                ...
                public void run() {
                    try {
                        ...
                        CloudDB.this.androidUIHandler.post(new C02221());
                    } catch (JSONException e) {
    ...
    public void GetTagList() {
        ...
        boolean isConnected = networkInfo != null && networkInfo.isConnected();
        if (isConnected) {
            this.background.submit(new C02298());
        } else {
    ...
    private YailList readFile(String fileName) {
        ...
        try {
            ...
            if (fileName.startsWith("/")) {
                ...
                String encodedContent = Base64.encodeToString(FileUtil.readFile(fileName), 0);
