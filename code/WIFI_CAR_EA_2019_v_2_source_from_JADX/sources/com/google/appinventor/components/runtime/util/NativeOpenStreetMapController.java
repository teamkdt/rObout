...
class NativeOpenStreetMapController implements MapController, MapListener {
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController$14 */
    static /* synthetic */ class AnonymousClass14 {
        /* renamed from: $SwitchMap$org$osmdroid$views$overlay$ScaleBarOverlay$UnitsOfMeasure */
        static final /* synthetic */ int[] f8xde2f8ad0 = new int[UnitsOfMeasure.values().length];

        static {
            try {
                f8xde2f8ad0[UnitsOfMeasure.imperial.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f8xde2f8ad0[UnitsOfMeasure.metric.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            f6xbe9cb241 = new int[MapScaleUnits.values().length];
            try {
                f6xbe9cb241[MapScaleUnits.METRIC.ordinal()] = 1;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f6xbe9cb241[MapScaleUnits.IMPERIAL.ordinal()] = 2;
            } catch (NoSuchFieldError e4) {
            }
            f7x5f87d236 = new int[MapType.values().length];
            try {
                f7x5f87d236[MapType.ROADS.ordinal()] = 1;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f7x5f87d236[MapType.AERIAL.ordinal()] = 2;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f7x5f87d236[MapType.TERRAIN.ordinal()] = 3;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f7x5f87d236[MapType.UNKNOWN.ordinal()] = 4;
            } catch (NoSuchFieldError e8) {
            }
        }
    }

    /* renamed from: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController$1 */
    class C04091 implements OnTapListener {
        C04091() {
        }
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController$2 */
    class C04102 implements OnPreDrawListener {
        C04102() {
        }
    ...
    private class MapReadyHandler extends Handler {
        ...
        /* renamed from: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController$MapReadyHandler$1 */
            ...
            switch (msg.what) {
                case 0:
                    if (!NativeOpenStreetMapController.this.ready && NativeOpenStreetMapController.this.form.canDispatchEvent(null, "MapReady")) {
                        ...
                        NativeOpenStreetMapController.this.form.runOnUiThread(new C04191());
                    }
    ...
    NativeOpenStreetMapController(Form form) {
        ...
        this.view.addOnTapListener(new C04091());
    ...
    public void setCompassEnabled(boolean enabled) {
        if (enabled && this.compass == null) {
            ...
            this.view.getViewTreeObserver().addOnPreDrawListener(new C04102());
    ...
    public void addFeature(final MapMarker aiMarker) {
        createNativeMarker(aiMarker, new AsyncCallbackPair<Marker>() {
            ...
            /* renamed from: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController$3$1 */
            class C04111 implements OnMarkerClickListener {
                C04111() {
                }
            ...
            /* renamed from: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController$3$2 */
            class C04122 implements OnMarkerDragListener {
                C04122() {
                }
            ...
            public void onSuccess(Marker overlay) {
                overlay.setOnMarkerClickListener(new C04111());
                overlay.setOnMarkerDragListener(new C04122());
                if (aiMarker.Visible()) {
    ...
    public MapScaleUnits getScaleUnits() {
        switch (AnonymousClass14.f8xde2f8ad0[this.scaleBar.getUnitsOfMeasure().ordinal()]) {
            case 1:
