...
public final class Twitter extends AndroidNonvisibleComponent implements ActivityResultListener, Component {
    ...
    class C03556 implements Runnable {
        ...
        class C03541 implements Runnable {
            ...
            public void run() {
                ...
                for (Status status : C03556.this.replies) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C03541());
            }
        }
    }
    ...
    class C03577 implements Runnable {
        ...
        class C03561 implements Runnable {
            ...
            public void run() {
                ...
                for (User user : C03577.this.friends) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C03561());
            }
        }
    }

    /* renamed from: com.google.appinventor.components.runtime.Twitter$8 */
    class C03598 implements Runnable {
        ...
        class C03581 implements Runnable {
            ...
            public void run() {
                ...
                for (DirectMessage message : C03598.this.messages) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C03581());
            }
        }
    }
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                if (Twitter.this.checkAccessToken(myConsumerKey, myConsumerSecret)) {
                    Twitter.this.handler.post(new C03431());
                    return;
                }
                try {
                    ...
                    Twitter.this.handler.post(new C03442());
                }
            }
        });
    }
    ...
    public void CheckAuthorized() {
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                if (Twitter.this.checkAccessToken(myConsumerKey, myConsumerSecret)) {
                    Twitter.this.handler.post(new C03481());
                }
            }
        });
    }
                ...
                AsynchUtil.runAsynchronously(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            Twitter.this.handler.post(new C03501());
                        } catch (TwitterException e) {
    ...
    public void RequestMentions() {
        ...
        AsynchUtil.runAsynchronously(new C03556());
    }
    ...
    public void RequestFollowers() {
        ...
        AsynchUtil.runAsynchronously(new C03577());
    }
    ...
    public void RequestDirectMessages() {
        ...
        AsynchUtil.runAsynchronously(new C03598());
    }
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Twitter.this.handler.post(new C03451());
                }
            }
        });
    }
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Twitter.this.handler.post(new C03461());
                }
            }
        });
    }
