...
public class Voting extends AndroidNonvisibleComponent implements Component {
    ...
    class C05252 implements AsyncCallbackPair<JSONObject> {
        ...
        public void onSuccess(JSONObject result) {
            if (result == null) {
                Voting.this.androidUIHandler.post(new C03641());
                return;
            }
            try {
                ...
                if (Voting.this.isPolling.booleanValue()) {
                    ...
                    Voting.this.androidUIHandler.post(new C03652());
                    return;
                }
                Voting.this.androidUIHandler.post(new C03663());
            } catch (JSONException e) {
                Voting.this.androidUIHandler.post(new C03674());
            }
        }
    ...
    class C05264 implements AsyncCallbackPair<String> {
        ...
        public void onSuccess(String response) {
            Voting.this.androidUIHandler.post(new C03701());
        }
    ...
    public void RequestBallot() {
        AsynchUtil.runAsynchronously(new C03631());
    }

    private void postRequestBallot() {
        WebServiceUtil.getInstance().postCommandReturningObject(this.serviceURL, REQUESTBALLOT_COMMAND, null, new C05252());
    }
    ...
    public void SendBallot() {
        AsynchUtil.runAsynchronously(new C03693());
    }

    private void postSendBallot(String userChoice, String userId) {
        AsyncCallbackPair<String> myCallback = new C05264();
