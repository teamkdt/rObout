...
public class FullScreenVideoUtil implements OnCompletionListener, OnPreparedListener {
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.FullScreenVideoUtil$3 */
    class C03983 implements OnTouchListener {
        C03983() {
        }
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.FullScreenVideoUtil$4 */
    class C03994 implements Runnable {
        C03994() {
        }
    ...
    public Dialog createFullScreenVideoDialog() {
        ...
        this.mFullScreenVideoView.setOnTouchListener(new C03983());
    ...
    public void onPrepared(MediaPlayer arg0) {
        ...
        this.mFullScreenVideoView.start();
        this.mHandler.postDelayed(new C03994(), 100);
    }
