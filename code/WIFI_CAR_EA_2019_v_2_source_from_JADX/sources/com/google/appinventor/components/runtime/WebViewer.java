...
public final class WebViewer extends AndroidViewComponent {
    ...
    /* renamed from: com.google.appinventor.components.runtime.WebViewer$1 */
    ...
    public WebViewer(ComponentContainer container) {
        ...
        container.$add(this);
        this.webview.setOnTouchListener(new C03801());
        HomeUrl("");
        Width(-2);
        Height(-2);
    }
