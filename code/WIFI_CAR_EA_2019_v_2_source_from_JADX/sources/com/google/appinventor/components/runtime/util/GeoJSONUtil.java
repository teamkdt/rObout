...
public final class GeoJSONUtil {
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.GeoJSONUtil$1 */
    static class C05281 implements PropertyApplication {
        C05281() {
        }
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.GeoJSONUtil$2 */
    static class C05292 implements PropertyApplication {
        C05292() {
        }
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.GeoJSONUtil$3 */
    static class C05303 implements PropertyApplication {
        C05303() {
        }
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.GeoJSONUtil$4 */
    static class C05314 implements PropertyApplication {
        C05314() {
        }
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.GeoJSONUtil$5 */
    static class C05325 implements PropertyApplication {
        C05325() {
        }
        ...
        public void apply(MapFeature feature, Object value) {
            if (feature instanceof HasFill) {
                ...
                if (value instanceof Number) {
                    ...
                    intValue = GeoJSONUtil.parseColor(value.toString());
                }
                hasFill.FillColor(intValue);
            }
        }
    }

    /* renamed from: com.google.appinventor.components.runtime.util.GeoJSONUtil$6 */
    static class C05336 implements PropertyApplication {
        C05336() {
        }
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.GeoJSONUtil$7 */
    static class C05347 implements PropertyApplication {
        C05347() {
        }
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.GeoJSONUtil$8 */
    static class C05358 implements PropertyApplication {
        C05358() {
        }
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.GeoJSONUtil$9 */
    static class C05369 implements PropertyApplication {
        C05369() {
        }
        ...
        public void apply(MapFeature feature, Object value) {
            if (feature instanceof HasStroke) {
                ...
                hasStroke.StrokeColor(intValue);
            }
        }
    }
    ...
    static {
        ...
        SUPPORTED_PROPERTIES.put(PROPERTY_ANCHOR_HORIZONTAL.toLowerCase(), new C05281());
        SUPPORTED_PROPERTIES.put(PROPERTY_ANCHOR_VERTICAL.toLowerCase(), new C05292());
        SUPPORTED_PROPERTIES.put(PROPERTY_DESCRIPTION, new C05303());
        SUPPORTED_PROPERTIES.put(PROPERTY_DRAGGABLE, new C05314());
        SUPPORTED_PROPERTIES.put(PROPERTY_FILL, new C05325());
        SUPPORTED_PROPERTIES.put(PROPERTY_HEIGHT, new C05336());
        SUPPORTED_PROPERTIES.put(PROPERTY_IMAGE, new C05347());
        SUPPORTED_PROPERTIES.put(PROPERTY_INFOBOX, new C05358());
        SUPPORTED_PROPERTIES.put(PROPERTY_STROKE, new C05369());
