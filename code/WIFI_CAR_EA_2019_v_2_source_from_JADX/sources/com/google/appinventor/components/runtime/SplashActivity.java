...
public final class SplashActivity extends AppInventorCompatActivity {
    ...
    /* renamed from: com.google.appinventor.components.runtime.SplashActivity$1 */
    class C03261 extends WebChromeClient {
        C03261() {
        }
    ...
    public class JavaInterface {
        ...
        /* renamed from: com.google.appinventor.components.runtime.SplashActivity$JavaInterface$1 */
        ...
        public void finished() {
            SplashActivity.this.handler.post(new C03271());
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.webview.setWebChromeClient(new C03261());
        setContentView(this.webview);
        this.webview.addJavascriptInterface(android, "Android");
