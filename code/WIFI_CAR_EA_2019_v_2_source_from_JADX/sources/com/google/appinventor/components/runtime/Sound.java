...
public class Sound extends AndroidNonvisibleComponent implements Component, OnResumeListener, OnStopListener, OnDestroyListener, Deleteable {
    ...
    /* renamed from: com.google.appinventor.components.runtime.Sound$1 */
    ...
    private class OnLoadHelper {
        ...
        /* renamed from: com.google.appinventor.components.runtime.Sound$OnLoadHelper$1 */
        class C03241 implements OnLoadCompleteListener {
            C03241() {
            }
        ...
        public void setOnloadCompleteListener(SoundPool soundPool) {
            soundPool.setOnLoadCompleteListener(new C03241());
        }
    }
    ...
    private void playWhenLoadComplete() {
        ...
        this.playWaitHandler.postDelayed(new C03231(), 50);
    }
