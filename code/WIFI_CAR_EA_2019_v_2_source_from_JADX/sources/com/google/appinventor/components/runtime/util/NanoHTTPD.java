...
public class NanoHTTPD {
    ...
    private class myThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(Runnable r) {
            Thread retval = new Thread(new ThreadGroup("biggerstack"), r, "HTTPD Session", PlaybackStateCompat.ACTION_SET_REPEAT_MODE);
    ...
    public NanoHTTPD(int port, File wwwroot) throws IOException {
        ...
        this.myThread = new Thread(new C04071());
                        ...
                        for (int i = 0; i < files.length; i++) {
                            ...
                            if (curFile.isFile()) {
                                ...
                                if (len < PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) {
                                    msg = msg + len + " bytes";
                                } else if (len < PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED) {
                                    msg = msg + (len / PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) + "." + (((len % PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) / 10) % 100) + " KB";
                                } else {
                                    msg = msg + (len / PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED) + "." + (((len % PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED) / 10) % 100) + " MB";
                                }
                                msg = msg + ")</font>";
                            }
                            msg = msg + "<br/>";
                ...
                if (res != null) {
                    ...
                    try {
                        ...
                        if (range != null || startFrom < 0) {
                            ...
                            InputStream c04082 = new FileInputStream(f) {
                                public int available() throws IOException {
                                    return (int) dataLen;
                                }
                            };
                            c04082.skip(startFrom);
                            response2 = new Response(HTTP_PARTIALCONTENT, mime, c04082);
