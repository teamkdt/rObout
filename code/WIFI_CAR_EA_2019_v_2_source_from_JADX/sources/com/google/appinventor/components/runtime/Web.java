            ...
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    try {
                        ...
                        Web.this.form.dispatchPermissionDeniedEvent(Web.this, "Get", e);
                    } catch (FileException e2) {
                        Web.this.form.dispatchErrorOccurredEvent(Web.this, "Get", e2.getErrorMessageNumber(), new Object[0]);
                    } catch (Exception e3) {
                        Log.e(Web.LOG_TAG, "ERROR_UNABLE_TO_GET", e3);
            ...
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    try {
                        ...
                        Web.this.form.dispatchPermissionDeniedEvent(Web.this, "PostFile", e);
                    } catch (FileException e2) {
            ...
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    try {
                        ...
                        Web.this.form.dispatchPermissionDeniedEvent(Web.this, "PutFile", e);
                    } catch (FileException e2) {
            ...
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    try {
                        ...
                        Web.this.form.dispatchPermissionDeniedEvent(Web.this, "Delete", e);
                    } catch (FileException e2) {
                ...
                public void run() {
                    try {
                        ...
                        try {
                            ...
                            Web.this.form.dispatchPermissionDeniedEvent(Web.this, str3, e);
                        } catch (FileException e2) {
