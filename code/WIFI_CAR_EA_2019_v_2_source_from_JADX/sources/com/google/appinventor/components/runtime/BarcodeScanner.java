...
public class BarcodeScanner extends AndroidNonvisibleComponent implements ActivityResultListener, Component {
    ...
    /* renamed from: com.google.appinventor.components.runtime.BarcodeScanner$1 */
    class C04941 implements PermissionResultHandler {
        C04941() {
        }
    ...
    public void DoScan() {
        ...
        if (!this.useExternalScanner && SdkLevel.getLevel() >= 5) {
            if (this.havePermission) {
                ...
                this.container.$form().askPermission("android.permission.CAMERA", new C04941());
                return;
            }
        }
