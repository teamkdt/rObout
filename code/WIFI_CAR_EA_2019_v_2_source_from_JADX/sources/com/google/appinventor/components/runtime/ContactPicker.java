...
public class ContactPicker extends Picker implements ActivityResultListener {
    ...
    /* renamed from: com.google.appinventor.components.runtime.ContactPicker$1 */
    class C04981 implements PermissionResultHandler {
        C04981() {
        }
    ...
    public void click() {
        if (this.havePermission) {
            ...
            this.container.$form().askPermission("android.permission.READ_CONTACTS", new C04981());
        }
    }
