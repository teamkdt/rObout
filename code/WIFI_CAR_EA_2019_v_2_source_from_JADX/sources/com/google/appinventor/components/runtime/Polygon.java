...
public class Polygon extends PolygonBase implements MapPolygon {
    ...
    private static final MapFeatureVisitor<Double> distanceComputation = new C05171();
    ...
    /* renamed from: com.google.appinventor.components.runtime.Polygon$1 */
    static class C05171 implements MapFeatureVisitor<Double> {
        C05171() {
        }
