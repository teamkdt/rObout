    ...
    public void RecordVideo() {
        ...
        if (!this.havePermission) {
            ...
            this.form.runOnUiThread(new Runnable() {
                ...
                /* renamed from: com.google.appinventor.components.runtime.Camcorder$1$1 */
                class C04951 implements PermissionResultHandler {
                    C04951() {
                    }
                ...
                public void run() {
                    Camcorder.this.form.askPermission("android.permission.CAMERA", new C04951());
                }
            });
