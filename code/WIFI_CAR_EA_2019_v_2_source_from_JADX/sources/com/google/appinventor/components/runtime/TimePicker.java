...
public class TimePicker extends ButtonBase {
    ...
    private OnTimeSetListener timePickerListener = new C03341();

    /* renamed from: com.google.appinventor.components.runtime.TimePicker$1 */
    class C03341 implements OnTimeSetListener {

        /* renamed from: com.google.appinventor.components.runtime.TimePicker$1$1 */
        ...
        public void onTimeSet(android.widget.TimePicker view, int selectedHour, int selectedMinute) {
            if (view.isShown()) {
                ...
                TimePicker.this.androidUIHandler.post(new C03331());
            }
        }
    }
