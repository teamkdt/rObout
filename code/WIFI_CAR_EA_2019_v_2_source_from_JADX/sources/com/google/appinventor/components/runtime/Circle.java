...
public class Circle extends PolygonBase implements MapCircle {
    private static final MapFeatureVisitor<Double> distanceComputation = new C04971();
    private GeoPoint center = new GeoPoint(0.0d, 0.0d);
    private double latitude;
    private double longitude;
    private double radius;

    /* renamed from: com.google.appinventor.components.runtime.Circle$1 */
    static class C04971 implements MapFeatureVisitor<Double> {
        C04971() {
        }
