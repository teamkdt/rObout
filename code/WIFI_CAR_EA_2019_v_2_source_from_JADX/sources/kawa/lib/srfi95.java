...
public class srfi95 extends ModuleBody {
    ...
    public static Object merge(Object a, Object b, Object isLess, Object key) {
        ...
        return frame.lambda1loop(lists.car.apply1(a), Scheme.applyToArgs.apply2(frame.key, lists.car.apply1(a)), lists.cdr.apply1(a), lists.car.apply1(b), Scheme.applyToArgs.apply2(frame.key, lists.car.apply1(b)), lists.cdr.apply1(b));
    }
    ...
    static Object sort$ClMerge$Ex(Object a, Object b, Object isLess, Object key) {
        ...
        Object kcara = Scheme.applyToArgs.apply2(frame1.key, lists.car.apply1(a));
        Object kcarb = Scheme.applyToArgs.apply2(frame1.key, lists.car.apply1(b));
        if (Scheme.applyToArgs.apply3(frame1.less$Qu, kcarb, kcara) == Boolean.FALSE) {
            if (lists.isNull(lists.cdr.apply1(a))) {
                try {
                    lists.setCdr$Ex((Pair) a, b);
                } catch (ClassCastException e) {
            ...
            frame1.lambda3loop(a, lists.cdr.apply1(a), Scheme.applyToArgs.apply2(frame1.key, lists.cadr.apply1(a)), b, kcarb);
            return a;
            ...
            frame1.lambda3loop(b, a, kcara, lists.cdr.apply1(b), Scheme.applyToArgs.apply2(frame1.key, lists.cadr.apply1(b)));
            return b;
        }
    }
    ...
    public static Object $PcSortList(Object seq, Object isLess, Object key) {
        ...
        if (key != Boolean.FALSE) {
            ...
            obj = frame0.seq;
            try {
                frame0.seq = frame0.lambda2step(Integer.valueOf(lists.length((LList) obj)));
                lst = frame0.seq;
                while (!lists.isNull(lst)) {
                    try {
        ...
        obj = frame0.seq;
        try {
            return frame0.lambda2step(Integer.valueOf(lists.length((LList) obj)));
