...
public class misc extends ModuleBody {
    ...
    public static Object error$V(Object msg, Object[] argsArray) {
        ...
        frame.msg = ports.callWithOutputString(frame.lambda$Fn4);
        ...
        while (obj != LList.Empty) {
            try {
                ...
                frame0.arg = arg;
                result = Pair.make(ports.callWithOutputString(frame0.lambda$Fn5), result);
                obj = arg02;
            } catch (ClassCastException e) {
                throw new WrongType(e, "arg0", -2, obj);
            }
        }
        return Scheme.apply.apply4(throw_name.throwName, Lit3, frame.msg, LList.reverseInPlace(result));
    }
