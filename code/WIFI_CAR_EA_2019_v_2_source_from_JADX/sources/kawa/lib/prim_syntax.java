...
public class prim_syntax extends ModuleBody {
    ...
    /* renamed from: if */
    public static final Macro f108if;
    ...
    static {
        ...
        f108if = Macro.make(simpleSymbol, moduleMethod, $instance);
        simpleSymbol = Lit25;
    ...
    static Object lambda3(Object form) {
        ...
        if (!Lit30.match(form, frame.$unnamed$0, 0)) {
            return syntax_case.error("syntax-case", form);
        }
        frame.lambda4processBinding(Lit31.execute(frame.$unnamed$0, TemplateScope.make()));
        ...
        objArr[0] = Lit32.execute(frame.$unnamed$0, TemplateScope.make());
        Object[] objArr2 = new Object[2];
        objArr2[0] = frame.out$Mnbindings;
        objArr2[1] = Quote.append$V(new Object[]{frame.out$Mninits, Lit33.execute(frame.$unnamed$0, r1)});
