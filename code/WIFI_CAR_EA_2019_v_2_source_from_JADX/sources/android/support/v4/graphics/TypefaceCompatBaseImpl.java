...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C04551 implements StyleExtractor<FontInfo> {
        C04551() {
        }
    ...
    class C04562 implements StyleExtractor<FontFileResourceEntry> {
        C04562() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C04551());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C04562());
    }
