...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01241();
    ...
    private static final Interpolator sInterpolator = new C01252();
    ...
    private final Runnable mEndScrollRunnable = new C01263();
    ...
    static class C01241 implements Comparator<ItemInfo> {
        C01241() {
        }
    ...
    static class C01252 implements Interpolator {
        C01252() {
        }
    ...
    class C04744 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C01271();
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C01271 implements ClassLoaderCreator<SavedState> {
            C01271() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C04744());
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8) {
                lp = (LayoutParams) child.getLayoutParams();
                if (lp == null || !lp.isDecor) {
                    child.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp.widthFactor), Declaration.MODULE_REFERENCE), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
                ...
                if (!lp.isDecor) {
                    ...
                    if (ii != null) {
                        ...
                        if (lp.needsMeasure) {
                            ...
                            child.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp.widthFactor), Declaration.MODULE_REFERENCE), MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, Declaration.MODULE_REFERENCE));
                        }
                        child.layout(childLeft, childTop, child.getMeasuredWidth() + childLeft, child.getMeasuredHeight() + childTop);
                    }
                }
