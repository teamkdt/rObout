...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00402();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00391();
    ...
    class C00402 implements OnItemClickListener {
        C00402() {
        }
