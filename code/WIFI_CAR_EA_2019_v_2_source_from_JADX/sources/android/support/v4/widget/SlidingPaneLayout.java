        ...
        for (i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp.height == -2) {
                    ...
                    childHeightSpec = MeasureSpec.makeMeasureSpec(lp.height, Declaration.MODULE_REFERENCE);
                }
                ...
                if (child.getVisibility() != 8) {
                    ...
                    if (child.getVisibility() != 8) {
                        ...
                        if (!canSlide || child == this.mSlideableView) {
                            if (lp.weight > 0.0f) {
                                if (lp.width != 0) {
                                    childHeightSpec = MeasureSpec.makeMeasureSpec(child.getMeasuredHeight(), Declaration.MODULE_REFERENCE);
                                } else if (lp.height == -2) {
                                    childHeightSpec = MeasureSpec.makeMeasureSpec(maxLayoutHeight, Integer.MIN_VALUE);
                                } else if (lp.height == -1) {
                                    childHeightSpec = MeasureSpec.makeMeasureSpec(maxLayoutHeight, Declaration.MODULE_REFERENCE);
                                ...
                                if (canSlide) {
                                    ...
                                    childWidthSpec = MeasureSpec.makeMeasureSpec(newWidth, Declaration.MODULE_REFERENCE);
                                    if (measuredWidth != newWidth) {
                                        child.measure(childWidthSpec, childHeightSpec);
                                    }
                                } else {
                                    child.measure(MeasureSpec.makeMeasureSpec(measuredWidth + ((int) ((lp.weight * ((float) Math.max(0, widthRemaining))) / weightSum)), Declaration.MODULE_REFERENCE), childHeightSpec);
                                }
                            }
                            ...
                            child.measure(MeasureSpec.makeMeasureSpec(fixedPanelWidthLimit, Declaration.MODULE_REFERENCE), childHeightSpec);
                        }
                    }
                }
            }
