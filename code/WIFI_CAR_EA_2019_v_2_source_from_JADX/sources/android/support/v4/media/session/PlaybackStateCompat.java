...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C00881();
    ...
    static class C00881 implements Creator<PlaybackStateCompat> {
        C00881() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C00891();
        ...
        static class C00891 implements Creator<CustomAction> {
            C00891() {
            }
