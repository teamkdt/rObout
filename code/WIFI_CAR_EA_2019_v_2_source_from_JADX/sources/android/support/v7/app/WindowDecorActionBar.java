...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C05481();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C05492();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C04843();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C04843 implements ViewPropertyAnimatorUpdateListener {
        C04843() {
        }
    ...
    class C05481 extends ViewPropertyAnimatorListenerAdapter {
        C05481() {
        }
    ...
    class C05492 extends ViewPropertyAnimatorListenerAdapter {
        C05492() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0168R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0168R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0168R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0168R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0168R.styleable.ActionBar, C0168R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0168R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0168R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0168R.attr.actionBarWidgetTheme, outValue, true);
