...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, C0168R.styleable.ButtonBarLayout);
        this.mAllowStacking = ta.getBoolean(C0168R.styleable.ButtonBarLayout_allowStacking, allowStackingDefault);
        ta.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isStacked() || MeasureSpec.getMode(widthMeasureSpec) != Declaration.MODULE_REFERENCE) {
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0168R.id.spacer);
        if (spacer != null) {
