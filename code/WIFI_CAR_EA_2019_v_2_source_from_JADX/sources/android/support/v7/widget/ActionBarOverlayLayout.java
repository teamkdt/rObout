...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0168R.attr.actionBarSize, 16842841};
    ...
    class C01771 extends AnimatorListenerAdapter {
        C01771() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C01771();
        this.mRemoveActionBarHideOffset = new C01782();
        this.mAddActionBarHideOffset = new C01793();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0168R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0168R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0168R.id.action_bar));
        }
    }
