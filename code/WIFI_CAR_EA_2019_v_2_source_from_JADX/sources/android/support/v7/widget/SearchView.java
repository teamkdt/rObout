...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01953 implements OnFocusChangeListener {
        C01953() {
        }
    ...
    class C01964 implements OnLayoutChangeListener {
        C01964() {
        }
    ...
    class C01975 implements OnClickListener {
        C01975() {
        }
    ...
    class C01986 implements OnKeyListener {
        C01986() {
        }
    ...
    class C01997 implements OnEditorActionListener {
        C01997() {
        }
    ...
    class C02008 implements OnItemClickListener {
        C02008() {
        }
    ...
    class C02019 implements OnItemSelectedListener {
        C02019() {
        }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0168R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
            this.mRunShowSoftInputIfNecessary = new C02031();
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0168R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateDrawableStateRunnable = new C01931();
        this.mReleaseCursorRunnable = new C01942();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01975();
        this.mTextKeyListener = new C01986();
        this.mOnEditorActionListener = new C01997();
        this.mOnItemClickListener = new C02008();
        this.mOnItemSelectedListener = new C02019();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0168R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0168R.styleable.SearchView_layout, C0168R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0168R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0168R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0168R.id.search_plate);
        this.mSubmitArea = findViewById(C0168R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0168R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0168R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0168R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0168R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0168R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0168R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0168R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0168R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0168R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0168R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0168R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0168R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0168R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0168R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0168R.styleable.SearchView_suggestionRowLayout, C0168R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0168R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01953());
        setIconifiedByDefault(a.getBoolean(C0168R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0168R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0168R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0168R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0168R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0168R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0168R.styleable.SearchView_android_focusable, true));
        a.recycle();
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C01964());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0168R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0168R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0168R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0168R.dimen.abc_dropdownitem_text_padding_left) : 0;
