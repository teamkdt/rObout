...
public class PopupMenu {
    ...
    class C01912 implements android.widget.PopupWindow.OnDismissListener {
        C01912() {
        }
    ...
    class C04911 implements Callback {
        C04911() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0168R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C04911());
        ...
        this.mPopup.setOnDismissListener(new C01912());
    }
