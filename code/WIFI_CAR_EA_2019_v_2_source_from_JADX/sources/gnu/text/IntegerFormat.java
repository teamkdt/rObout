    ...
    public int format(Object arg, int start, Writer dst, FieldPosition fpos) throws IOException {
        ...
        if (sarg != null) {
            ...
            if (padRight) {
                for (minWidth = 
/*
Method generation error in method: gnu.text.IntegerFormat.format(java.lang.Object, int, java.io.Writer, java.text.FieldPosition):int, dex: classes.dex
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r9_6 'minWidth' int) = (r9_3 'minWidth' int), (r9_4 'minWidth' int) binds: {(r9_4 'minWidth' int)=B:126:0x0278, (r9_3 'minWidth' int)=B:90:0x01da} in method: gnu.text.IntegerFormat.format(java.lang.Object, int, java.io.Writer, java.text.FieldPosition):int, dex: classes.dex
	...
	at jadx.api.JadxDecompiler$$Lambda$8/240166646.run(Unknown Source)
