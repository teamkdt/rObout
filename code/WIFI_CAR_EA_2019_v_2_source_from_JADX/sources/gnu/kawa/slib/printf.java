...
public class printf extends ModuleBody {
    ...
    public class frame4 extends ModuleBody {
        ...
        Object lambda13(Object i, Object fdigs) {
            ...
            if (Scheme.numGEq.apply2(i, Integer.valueOf(this.staticLink.staticLink.staticLink.f32n)) != Boolean.FALSE) {
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda2sign(Object i, Object cont) {
            if (Scheme.numLss.apply2(i, Integer.valueOf(this.f32n)) == Boolean.FALSE) {
                return Values.empty;
            }
            Object obj = this.str;
            try {
        ...
        public Object lambda3digits(Object i, Object cont) {
            ...
            Object j = i;
            while (true) {
                Object apply2 = Scheme.numGEq.apply2(j, Integer.valueOf(this.f32n));
                try {
        ...
        Object lambda5(Object i, Object sgn, Object digs, Object ex) {
            ...
            frame0.digs = digs;
            frame0.ex = ex;
            if (Scheme.numEqu.apply2(i, Integer.valueOf(this.f32n)) != Boolean.FALSE) {
                ...
                try {
                    ...
                    try {
                        try {
                            ...
                            obj = this.str;
                            try {
                                frame0.num = numbers.string$To$Number((CharSequence) obj);
                                if (frame0.num == Boolean.FALSE) {
                                    return lambda1parseError();
                                }
                                obj = frame0.num;
                                try {
                                    return printf.stdio$ClParseFloat(numbers.number$To$String(numbers.realPart((Complex) obj)), frame0.lambda$Fn3);
                                } catch (ClassCastException e) {
    ...
    public static Object stdio$ClParseFloat(Object str, Object proc) {
        ...
        frame.str = str;
        frame.proc = proc;
        Object obj = frame.str;
        try {
            frame.f32n = strings.stringLength((CharSequence) obj);
    ...
    public static Object fprintf$V(Object port, Object format, Object[] argsArray) {
        ...
        frame12.cnt = Lit1;
        Scheme.apply.apply4(stdio$Cliprintf, frame12.lambda$Fn18, format, args);
        return frame12.cnt;
    }
    ...
    public static Object sprintf$V(Object str, Object format, Object[] argsArray) {
        ...
        LList args = LList.makeList(argsArray, 0);
        frame13.cnt = Lit1;
        if (strings.isString(frame13.str)) {
            obj = frame13.str;
        } else if (numbers.isNumber(frame13.str)) {
            Object obj2 = frame13.str;
            try {
                obj = strings.makeString(((Number) obj2).intValue());
            } catch (ClassCastException e) {
                throw new WrongType(e, "make-string", 1, obj2);
            }
        } else if (frame13.str == Boolean.FALSE) {
            obj = strings.makeString(100);
        } else {
            obj = misc.error$V(Lit68, new Object[]{"first argument not understood", frame13.str});
        }
        frame13.f31s = obj;
        obj = frame13.f31s;
        try {
            frame13.end = Integer.valueOf(strings.stringLength((CharSequence) obj));
            Scheme.apply.apply4(stdio$Cliprintf, frame13.lambda$Fn19, format, args);
            if (strings.isString(frame13.str)) {
                return frame13.cnt;
            }
            if (Scheme.isEqv.apply2(frame13.end, frame13.cnt) != Boolean.FALSE) {
                return frame13.f31s;
            }
            obj = frame13.f31s;
            try {
                CharSequence charSequence = (CharSequence) obj;
                Object obj3 = frame13.cnt;
                try {
