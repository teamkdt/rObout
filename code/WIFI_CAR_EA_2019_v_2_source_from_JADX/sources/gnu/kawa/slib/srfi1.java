...
public class srfi1 extends ModuleBody {
    ...
    /* renamed from: break */
    public static final ModuleMethod f98break;
    ...
    public class frame10 extends ModuleBody {
        ...
        public Object lambda19recur(Object lists) {
            ...
            return Scheme.apply.apply2(this.f33f, srfi1.append$Ex$V(new Object[]{lists, LList.list1(lambda19recur(cdrs))}));
        }

        public Object lambda20recur(Object lis) {
            return srfi1.isNullList(lis) != Boolean.FALSE ? this.zero : this.f33f.apply2(lis, lambda20recur(lists.cdr.apply1(lis)));
        }
    }
    ...
    public class frame11 extends ModuleBody {
        ...
        public Object lambda21recur(Object head, Object lis) {
            if (lists.isPair(lis)) {
                return this.f34f.apply2(head, lambda21recur(lists.car.apply1(lis), lists.cdr.apply1(lis)));
            }
            return head;
        }
    }
    ...
    public class frame12 extends ModuleBody {
        ...
        void lambda22(Object pair) {
            try {
                lists.setCar$Ex((Pair) pair, this.f35f.apply1(lists.car.apply1(pair)));
    ...
    public class frame14 extends ModuleBody {
        ...
        Object lambda25(Object cars, Object cdrs) {
            ...
            Boolean head = Scheme.apply.apply2(this.staticLink.f36f, cars);
    ...
    public class frame17 extends ModuleBody {
        ...
        boolean lambda28(Object y) {
            return ((Scheme.applyToArgs.apply3(this.maybe$Mn$Eq, this.f37x, y) != Boolean.FALSE ? 1 : 0) + 1) & 1;
        }
    ...
    public class frame18 extends ModuleBody {
        ...
        boolean lambda29(Object y) {
            return ((Scheme.applyToArgs.apply3(this.maybe$Mn$Eq, this.f38x, y) != Boolean.FALSE ? 1 : 0) + 1) & 1;
        }
    ...
    public class frame31 extends ModuleBody {
        ...
        Object lambda46(Object heads, Object tails) {
            ...
            if (!x) {
                ...
                return this.staticLink.lambda44lp(tails, AddOp.$Pl.apply2(this.f39n, srfi1.Lit1));
            }
        }
    ...
    public class frame38 extends ModuleBody {
        ...
        Object lambda55(Object lis) {
            return lists.member(this.f40x, lis, this.staticLink.$Eq);
        }
    ...
    public class frame40 extends ModuleBody {
        ...
        Object lambda57(Object lis) {
            return lists.member(this.f41x, lis, this.staticLink.$Eq);
        }
    ...
    public class frame42 extends ModuleBody {
        ...
        boolean lambda59(Object lis) {
            return ((lists.member(this.f42x, lis, this.staticLink.$Eq) != Boolean.FALSE ? 1 : 0) + 1) & 1;
        }
    ...
    public class frame44 extends ModuleBody {
        ...
        boolean lambda61(Object lis) {
            return ((lists.member(this.f43x, lis, this.staticLink.$Eq) != Boolean.FALSE ? 1 : 0) + 1) & 1;
        }
    ...
    public class frame46 extends ModuleBody {
        ...
        Object lambda63() {
            return srfi1.lsetDiff$PlIntersection$V(this.staticLink.$Eq, this.f44a, new Object[]{this.f45b});
        }
        ...
        Object lambda64(Object a$Mnb, Object aIntB) {
            ...
            if (lists.isNull(a$Mnb)) {
                return srfi1.lsetDifference$V(this.staticLink.$Eq, this.f45b, new Object[]{this.f44a});
            } else if (!lists.isNull(frame47.a$Mnint$Mnb)) {
                return srfi1.fold$V(frame47.lambda$Fn48, a$Mnb, this.f45b, new Object[0]);
            } else {
                return append.append$V(new Object[]{this.f45b, this.f44a});
            }
        }
    ...
    public class frame49 extends ModuleBody {
        ...
        Object lambda67() {
            return srfi1.lsetDiff$PlIntersection$Ex$V(this.staticLink.$Eq, this.f46a, new Object[]{this.f47b});
        }
        ...
        Object lambda68(Object a$Mnb, Object aIntB) {
            ...
            if (lists.isNull(a$Mnb)) {
                return srfi1.lsetDifference$Ex$V(this.staticLink.$Eq, this.f47b, new Object[]{this.f46a});
            } else if (!lists.isNull(frame50.a$Mnint$Mnb)) {
                return srfi1.pairFold$V(frame50.lambda$Fn52, a$Mnb, this.f47b, new Object[0]);
            } else {
                return srfi1.append$Ex$V(new Object[]{this.f47b, this.f46a});
            }
        }
    ...
    public class frame60 extends ModuleBody {
        ...
        Object lambda82(Object cars, Object cdrs) {
            return misc.values(lists.cons(this.f48a, cars), lists.cons(this.f49d, cdrs));
        }
    ...
    public class frame66 extends ModuleBody {
        ...
        Object lambda91(Object cars, Object cdrs) {
            return misc.values(lists.cons(this.f50a, cars), lists.cons(this.f51d, cdrs));
        }
    ...
    public class frame70 extends ModuleBody {
        ...
        Object lambda98(Object cars, Object cdrs) {
            return misc.values(lists.cons(this.f52a, cars), lists.cons(this.f53d, cdrs));
        }
    ...
    static {
        ...
        unzip1 = new ModuleMethod(moduleBody, 112, Lit35, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        f98break = new ModuleMethod(moduleBody, 164, Lit80, 8194);
    ...
    static Object $PcCdrs(Object lists) {
        ...
        try {
            ...
            frame55.abort = abort;
            Object lambda74recur = frame55.lambda74recur(lists);
            abort.invoked = true;
    ...
    static Object $PcCars$Pl(Object lists, Object lastElt) {
        ...
        frame56.last$Mnelt = lastElt;
        return frame56.lambda75recur(lists);
    }
    ...
    static Object $PcCars$PlCdrs(Object lists) {
        ...
        try {
            ...
            frame57.abort = abort;
            Object lambda76recur = frame57.lambda76recur(lists);
            abort.invoked = true;
    ...
    static Object $PcCars$PlCdrs$SlPair(Object lists) {
        ...
        frame61.lists = lists;
        return call_with_values.callWithValues(frame61.lambda$Fn63, lambda$Fn64);
    }
    ...
    static Object $PcCars$PlCdrs$Pl(Object lists, Object carsFinal) {
        ...
        try {
            ...
            frame63.staticLink = closureEnv;
            frame63.abort = abort;
            Object lambda85recur = frame63.lambda85recur(lists);
            abort.invoked = true;
    ...
    static Object $PcCars$PlCdrs$SlNoTest$SlPair(Object lists) {
        ...
        frame71.lists = lists;
        return call_with_values.callWithValues(frame71.lambda$Fn77, lambda$Fn78);
    }
    ...
    public static Object fold$V(Procedure kons, Object knil, Object lis1, Object[] argsArray) {
        ...
        if (lists.isPair(lists)) {
            return frame7.lambda14lp(lists.cons(lis1, lists), knil);
        }
        Object lis = lis1;
        while (isNullList(lis) == Boolean.FALSE) {
            Object lis2 = lists.cdr.apply1(lis);
            knil = frame7.kons.apply2(lists.car.apply1(lis), knil);
            lis = lis2;
        }
        return knil;
    }
    ...
    public static Object foldRight$V(Procedure kons, Object knil, Object lis1, Object[] argsArray) {
        ...
        LList lists = LList.makeList(argsArray, 0);
        if (lists.isPair(lists)) {
            return frame9.lambda17recur(lists.cons(lis1, lists));
        }
        return frame9.lambda18recur(lis1);
    }
    ...
    public static Object pairFoldRight$V(Procedure f, Object zero, Object lis1, Object[] argsArray) {
        ...
        LList lists = LList.makeList(argsArray, 0);
        if (lists.isPair(lists)) {
            return frame10.lambda19recur(lists.cons(lis1, lists));
        }
        return frame10.lambda20recur(lis1);
    }
    ...
    public static Object reduceRight(Procedure f, Object ridentity, Object lis) {
        ...
        frame11.f34f = f;
        return isNullList(lis) != Boolean.FALSE ? ridentity : frame11.lambda21recur(lists.car.apply1(lis), lists.cdr.apply1(lis));
    }
    ...
    public static Object appendMap$V(Object f, Object lis1, Object[] argsArray) {
        ...
        return procedure.apply2(append, LList.reverseInPlace(result));
    }
    ...
    public static Object map$Ex$V(Procedure f, Object lis1, Object[] argsArray) {
        ...
        if (lists.isPair(lists)) {
            ...
            while (isNullList(lis12) == Boolean.FALSE) {
                ...
                try {
                    lists.setCar$Ex((Pair) lis12, Scheme.apply.apply3(frame12.f35f, lists.car.apply1(lis12), heads));
        ...
        pairForEach$V(frame12.lambda$Fn11, lis1, new Object[0]);
        return lis1;
    }
    ...
    public static Object filterMap$V(Procedure f, Object lis1, Object[] argsArray) {
        ...
        LList lists = LList.makeList(argsArray, 0);
        if (lists.isPair(lists)) {
            return frame13.lambda23recur(lists.cons(lis1, lists), LList.Empty);
        }
        Object obj = LList.Empty;
        Object lis = lis1;
        while (isNullList(lis) == Boolean.FALSE) {
            Boolean head = frame13.f36f.apply1(lists.car.apply1(lis));
            Object tail = lists.cdr.apply1(lis);
            if (head != Boolean.FALSE) {
    ...
    public static Object alistDelete(Object key, Object alist, Object maybe$Mn$Eq) {
        ...
        frame21.key = key;
        frame21.maybe$Mn$Eq = maybe$Mn$Eq;
        return filter(frame21.lambda$Fn18, alist);
    }

    public static Object alistDelete$Ex(Object key, Object alist, Object maybe$Mn$Eq) {
        frame22 frame22 = new frame22();
        frame22.key = key;
        frame22.maybe$Mn$Eq = maybe$Mn$Eq;
        return filter$Ex(frame22.lambda$Fn19, alist);
    }
    ...
    public static Object takeWhile(Procedure pred, Object lis) {
        ...
        frame23.pred = pred;
        return frame23.lambda34recur(lis);
    }
    ...
    /* renamed from: break */
    public static Object m31break(Object pred, Object lis) {
        frame24 frame24 = new frame24();
        frame24.pred = pred;
        return span(frame24.lambda$Fn20, lis);
    }

    public static Object break$Ex(Object pred, Object lis) {
        frame25 frame25 = new frame25();
        frame25.pred = pred;
        return span$Ex(frame25.lambda$Fn21, lis);
    }
    ...
    public static Object any$V(Procedure pred, Object lis1, Object[] argsArray) {
        ...
        frame26.pred = pred;
        frame26.lis1 = lis1;
        frame26.lists = LList.makeList(argsArray, 0);
        if (lists.isPair(frame26.lists)) {
            return call_with_values.callWithValues(frame26.lambda$Fn22, frame26.lambda$Fn23);
        }
        Object isNullList = isNullList(frame26.lis1);
        try {
            ...
            if (!x) {
                ...
                Object head = lists.car.apply1(frame26.lis1);
                for (Object tail = lists.cdr.apply1(frame26.lis1); isNullList(tail) == Boolean.FALSE; tail = lists.cdr.apply1(tail)) {
                    Boolean x2 = frame26.pred.apply1(head);
                    if (x2 != Boolean.FALSE) {
                        return x2;
                    }
                    head = lists.car.apply1(tail);
                }
                return frame26.pred.apply1(head);
            }
        } catch (ClassCastException e) {
            throw new WrongType(e, "x", -2, isNullList);
        }
    ...
    public static Object every$V(Procedure pred, Object lis1, Object[] argsArray) {
        ...
        frame27.pred = pred;
        frame27.lis1 = lis1;
        frame27.lists = LList.makeList(argsArray, 0);
        if (lists.isPair(frame27.lists)) {
            return call_with_values.callWithValues(frame27.lambda$Fn24, frame27.lambda$Fn25);
        }
        Boolean x = isNullList(frame27.lis1);
        if (x != Boolean.FALSE) {
            return x;
        }
        Object head = lists.car.apply1(frame27.lis1);
        for (Object tail = lists.cdr.apply1(frame27.lis1); isNullList(tail) == Boolean.FALSE; tail = lists.cdr.apply1(tail)) {
            x = frame27.pred.apply1(head);
            if (x == Boolean.FALSE) {
                return x;
            }
            head = lists.car.apply1(tail);
        }
        return frame27.pred.apply1(head);
    }
    ...
    public static Object listIndex$V(Procedure pred, Object lis1, Object[] argsArray) {
        ...
        LList lists = LList.makeList(argsArray, 0);
        if (lists.isPair(lists)) {
            return frame30.lambda44lp(lists.cons(lis1, lists), Lit0);
        }
        boolean x;
        Object n = Lit0;
        Object lis = lis1;
        while (true) {
            ...
            try {
                ...
                if (!x) {
                    break;
                } else if (frame30.pred.apply1(lists.car.apply1(lis)) != Boolean.FALSE) {
                    return n;
                } else {
                    lis = lists.cdr.apply1(lis);
    ...
    static Object $PcLset2$Ls$Eq(Object $Eq, Object lis1, Object lis2) {
        ...
        frame72.$Eq = $Eq;
        frame72.lis2 = lis2;
        return every$V(frame72.lambda$Fn79, lis1, new Object[0]);
    }
    ...
    public static Object lsetAdjoin$V(Procedure $Eq, Object lis, Object[] argsArray) {
        ...
        frame32.$Eq = $Eq;
        return fold$V(frame32.lambda$Fn30, lis, LList.makeList(argsArray, 0), new Object[0]);
    }

    public static Object lsetUnion$V(Procedure $Eq, Object[] argsArray) {
        frame33 frame33 = new frame33();
        frame33.$Eq = $Eq;
        return reduce(frame33.lambda$Fn31, LList.Empty, LList.makeList(argsArray, 0));
    }

    public static Object lsetUnion$Ex$V(Procedure $Eq, Object[] argsArray) {
        frame35 frame35 = new frame35();
        frame35.$Eq = $Eq;
        return reduce(frame35.lambda$Fn34, LList.Empty, LList.makeList(argsArray, 0));
    }

    public static Object lsetIntersection$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        frame37 frame37 = new frame37();
        frame37.$Eq = $Eq;
        frame37.lists = delete(lis1, LList.makeList(argsArray, 0), Scheme.isEq);
        if (any$V(null$Mnlist$Qu, frame37.lists, new Object[0]) != Boolean.FALSE) {
            return LList.Empty;
        }
        return !lists.isNull(frame37.lists) ? filter(frame37.lambda$Fn37, lis1) : lis1;
    }

    public static Object lsetIntersection$Ex$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        frame39 frame39 = new frame39();
        frame39.$Eq = $Eq;
        frame39.lists = delete(lis1, LList.makeList(argsArray, 0), Scheme.isEq);
        if (any$V(null$Mnlist$Qu, frame39.lists, new Object[0]) != Boolean.FALSE) {
            return LList.Empty;
        }
        return !lists.isNull(frame39.lists) ? filter$Ex(frame39.lambda$Fn39, lis1) : lis1;
    }

    public static Object lsetDifference$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        frame41 frame41 = new frame41();
        frame41.$Eq = $Eq;
        frame41.lists = filter(lists.pair$Qu, LList.makeList(argsArray, 0));
        if (lists.isNull(frame41.lists)) {
            return lis1;
        }
        if (lists.memq(lis1, frame41.lists) != Boolean.FALSE) {
            return LList.Empty;
        }
        return filter(frame41.lambda$Fn41, lis1);
    }

    public static Object lsetDifference$Ex$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        frame43 frame43 = new frame43();
        frame43.$Eq = $Eq;
        frame43.lists = filter(lists.pair$Qu, LList.makeList(argsArray, 0));
        if (lists.isNull(frame43.lists)) {
            return lis1;
        }
        if (lists.memq(lis1, frame43.lists) != Boolean.FALSE) {
            return LList.Empty;
        }
        return filter$Ex(frame43.lambda$Fn43, lis1);
    }

    public static Object lsetXor$V(Procedure $Eq, Object[] argsArray) {
        frame45 frame45 = new frame45();
        frame45.$Eq = $Eq;
        return reduce(frame45.lambda$Fn45, LList.Empty, LList.makeList(argsArray, 0));
    }

    public static Object lsetXor$Ex$V(Procedure $Eq, Object[] argsArray) {
        frame48 frame48 = new frame48();
        frame48.$Eq = $Eq;
        return reduce(frame48.lambda$Fn49, LList.Empty, LList.makeList(argsArray, 0));
    }

    public static Object lsetDiff$PlIntersection$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        frame51 frame51 = new frame51();
        frame51.$Eq = $Eq;
        frame51.lists = LList.makeList(argsArray, 0);
        if (every$V(null$Mnlist$Qu, frame51.lists, new Object[0]) != Boolean.FALSE) {
            return misc.values(lis1, LList.Empty);
        } else if (lists.memq(lis1, frame51.lists) == Boolean.FALSE) {
            return partition(frame51.lambda$Fn53, lis1);
        } else {
    ...
    public static Object lsetDiff$PlIntersection$Ex$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        ...
        frame53.$Eq = $Eq;
        frame53.lists = LList.makeList(argsArray, 0);
        if (every$V(null$Mnlist$Qu, frame53.lists, new Object[0]) != Boolean.FALSE) {
            return misc.values(lis1, LList.Empty);
        } else if (lists.memq(lis1, frame53.lists) == Boolean.FALSE) {
            return partition$Ex(frame53.lambda$Fn55, lis1);
        } else {
            return misc.values(LList.Empty, lis1);
        }
    }
