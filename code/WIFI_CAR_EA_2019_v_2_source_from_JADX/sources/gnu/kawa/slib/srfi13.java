...
public class srfi13 extends ModuleBody {
    ...
    public class frame0 extends ModuleBody {
        ...
        Object lambda3() {
            return srfi13.stringParseStart$PlEnd(this.proc, this.f54s, this.args);
        }
    ...
    public class frame10 extends ModuleBody {
        ...
        Object lambda25() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnany, this.f55s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame2 extends ModuleBody {
        ...
        Object lambda7() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mncopy, this.f56s, this.maybe$Mnstart$Plend);
        }

        CharSequence lambda8(Object start, Object end) {
            Object obj = this.f56s;
            try {
                try {
                    try {
    ...
    public class frame3 extends ModuleBody {
        ...
        Object lambda9() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnmap, this.f57s, this.maybe$Mnstart$Plend);
        }

        Object lambda10(Object start, Object end) {
            return srfi13.$PcStringMap(this.proc, this.f57s, start, end);
        }
    }
    ...
    public class frame4 extends ModuleBody {
        ...
        Object lambda11() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnmap$Ex, this.f58s, this.maybe$Mnstart$Plend);
        }

        Object lambda12(Object start, Object end) {
            return srfi13.$PcStringMap$Ex(this.proc, this.f58s, start, end);
        }
    }
    ...
    public class frame56 extends ModuleBody {
        ...
        Object lambda134() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnhash, this.f59s, srfi13.loc$rest.get());
        ...
        Object lambda135(Object start, Object end) {
            return srfi13.$PcStringHash(this.f59s, characters.char$Mn$Grinteger, this.bound, start, end);
        }
    }
    ...
    public class frame57 extends ModuleBody {
        ...
        Object lambda136() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnhash$Mnci, this.f60s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        Object lambda137(Object start, Object end) {
            return srfi13.$PcStringHash(this.f60s, srfi13.lambda$Fn138, this.bound, start, end);
        }
    }
    ...
    public class frame58 extends ModuleBody {
        ...
        Object lambda139() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnupcase, this.f61s, this.maybe$Mnstart$Plend);
        }

        Object lambda140(Object start, Object end) {
            return srfi13.$PcStringMap(unicode.char$Mnupcase, this.f61s, start, end);
        }
    }
    ...
    public class frame59 extends ModuleBody {
        ...
        Object lambda141() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnupcase$Ex, this.f62s, this.maybe$Mnstart$Plend);
        }

        Object lambda142(Object start, Object end) {
            return srfi13.$PcStringMap$Ex(unicode.char$Mnupcase, this.f62s, start, end);
        }
    }
    ...
    public class frame5 extends ModuleBody {
        ...
        Object lambda13() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfold, this.f63s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame60 extends ModuleBody {
        ...
        Object lambda143() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mndowncase, this.f64s, this.maybe$Mnstart$Plend);
        }

        Object lambda144(Object start, Object end) {
            return srfi13.$PcStringMap(unicode.char$Mndowncase, this.f64s, start, end);
        }
    }
    ...
    public class frame61 extends ModuleBody {
        ...
        Object lambda145() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mndowncase$Ex, this.f65s, this.maybe$Mnstart$Plend);
        }

        Object lambda146(Object start, Object end) {
            return srfi13.$PcStringMap$Ex(unicode.char$Mndowncase, this.f65s, start, end);
        }
    }
    ...
    public class frame62 extends ModuleBody {
        ...
        Object lambda147() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntitlecase$Ex, this.f66s, this.maybe$Mnstart$Plend);
        }

        Object lambda148(Object start, Object end) {
            return srfi13.$PcStringTitlecase$Ex(this.f66s, start, end);
        }
    }
    ...
    public class frame63 extends ModuleBody {
        ...
        Object lambda149() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntitlecase$Ex, this.f67s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame65 extends ModuleBody {
        ...
        boolean lambda152(Object val) {
            boolean x = numbers.isInteger(this.f70n);
            if (!x) {
                return x;
            }
            x = numbers.isExact(this.f70n);
            return x ? ((Boolean) Scheme.numLEq.apply3(srfi13.Lit0, this.f70n, Integer.valueOf(this.len))).booleanValue() : x;
        }
    ...
    public class frame66 extends ModuleBody {
        ...
        public frame66() {
            PropertySet moduleMethod = new ModuleMethod(this, 130, null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        boolean lambda153(Object val) {
            boolean x = numbers.isInteger(this.f71n);
            if (!x) {
                return x;
            }
            x = numbers.isExact(this.f71n);
            return x ? ((Boolean) Scheme.numLEq.apply3(srfi13.Lit0, this.f71n, Integer.valueOf(this.len))).booleanValue() : x;
        }
    ...
    public class frame67 extends ModuleBody {
        ...
        boolean lambda154(Object val) {
            boolean x = numbers.isInteger(this.f72n);
            if (!x) {
                return x;
            }
            x = numbers.isExact(this.f72n);
            return x ? ((Boolean) Scheme.numLEq.apply3(srfi13.Lit0, this.f72n, Integer.valueOf(this.len))).booleanValue() : x;
        }
    ...
    public class frame68 extends ModuleBody {
        ...
        Object lambda155() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntrim, this.f73s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
    ...
    public class frame69 extends ModuleBody {
        ...
        Object lambda157() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntrim$Mnright, this.f74s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        Object lambda158(Object start, Object end) {
            try {
                Boolean temp = srfi13.stringSkipRight$V(this.f74s, srfi13.loc$criterion.get(), new Object[]{start, end});
                if (temp == Boolean.FALSE) {
                    return "";
                }
                Object obj = this.f74s;
                try {
    ...
    public class frame6 extends ModuleBody {
        ...
        Object lambda15() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfold$Mnright, this.f75s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame70 extends ModuleBody {
        ...
        Object lambda159() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntrim$Mnboth, this.f76s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        Object lambda160(Object start, Object end) {
            try {
                Object temp = srfi13.stringSkip$V(this.f76s, srfi13.loc$criterion.get(), new Object[]{start, end});
                if (temp == Boolean.FALSE) {
                    return "";
                }
                Object obj = this.f76s;
                try {
                    CharSequence charSequence = (CharSequence) obj;
                    try {
                        int intValue = ((Number) temp).intValue();
                        try {
                            Object apply2 = AddOp.$Pl.apply2(srfi13.Lit1, srfi13.stringSkipRight$V(this.f76s, srfi13.loc$criterion.get(), new Object[]{temp, end}));
                            try {
    ...
    public class frame71 extends ModuleBody {
        ...
        Object lambda161() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnpad$Mnright, this.f78s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        Object lambda162(Object start, Object end) {
            Object obj;
            try {
                Scheme.applyToArgs.apply4(srfi13.loc$check$Mnarg.get(), srfi13.lambda$Fn163, this.f77n, srfi13.string$Mnpad$Mnright);
                if (Scheme.numLEq.apply2(this.f77n, AddOp.$Mn.apply2(end, start)) != Boolean.FALSE) {
                    obj = this.f78s;
                    try {
                        CharSequence charSequence = (CharSequence) obj;
                        try {
                            int intValue = ((Number) start).intValue();
                            Object apply2 = AddOp.$Pl.apply2(start, this.f77n);
                            try {
                                return srfi13.$PcSubstring$SlShared(charSequence, intValue, ((Number) apply2).intValue());
                            } catch (ClassCastException e) {
                                throw new WrongType(e, "%substring/shared", 2, apply2);
    ...
    public class frame72 extends ModuleBody {
        ...
        Object lambda164() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnpad, this.f80s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        Object lambda165(Object start, Object end) {
            Object obj;
            try {
                Scheme.applyToArgs.apply4(srfi13.loc$check$Mnarg.get(), srfi13.lambda$Fn166, this.f79n, srfi13.string$Mnpad);
                Object len = AddOp.$Mn.apply2(end, start);
                if (Scheme.numLEq.apply2(this.f79n, len) != Boolean.FALSE) {
                    obj = this.f80s;
                    try {
                        CharSequence charSequence = (CharSequence) obj;
                        Object apply2 = AddOp.$Mn.apply2(end, this.f79n);
                        try {
                            try {
                ...
                Object obj2 = this.f79n;
                try {
                    Object ans = strings.makeString(((Number) obj2).intValue(), LangPrimType.charType);
                    obj2 = AddOp.$Mn.apply2(this.f79n, len);
                    try {
                        int intValue = ((Number) obj2).intValue();
                        obj = this.f80s;
                        try {
    ...
    public class frame73 extends ModuleBody {
        ...
        Object lambda167() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mndelete, this.f81s, this.maybe$Mnstart$Plend);
        }
        ...
        CharSequence lambda168(Object start, Object end) {
            ...
            if (misc.isProcedure(this.criterion)) {
                ...
                try {
                    ...
                    Object ans$Mnlen = srfi13.stringFold$V(frame74.lambda$Fn169, srfi13.Lit0, this.f81s, new Object[]{start, end});
            ...
            try {
                ...
                frame74.cset = obj;
                Object len = srfi13.stringFold$V(frame74.lambda$Fn170, srfi13.Lit0, this.f81s, new Object[]{start, end});
                try {
                    frame74.ans = strings.makeString(((Number) len).intValue());
                    srfi13.stringFold$V(frame74.lambda$Fn171, srfi13.Lit0, this.f81s, new Object[]{start, end});
                    return frame74.ans;
                } catch (ClassCastException e22) {
    ...
    public class frame75 extends ModuleBody {
        ...
        Object lambda172() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfilter, this.f82s, this.maybe$Mnstart$Plend);
        }
        ...
        CharSequence lambda173(Object start, Object end) {
            ...
            if (misc.isProcedure(this.criterion)) {
                ...
                try {
                    ...
                    Object ans$Mnlen = srfi13.stringFold$V(frame76.lambda$Fn174, srfi13.Lit0, this.f82s, new Object[]{start, end});
                    if (Scheme.numEqu.apply2(ans$Mnlen, slen) != Boolean.FALSE) {
                        return frame76.temp;
                    }
                    try {
            ...
            try {
                ...
                frame76.cset = obj;
                Object len = srfi13.stringFold$V(frame76.lambda$Fn175, srfi13.Lit0, this.f82s, new Object[]{start, end});
                try {
                    frame76.ans = strings.makeString(((Number) len).intValue());
                    srfi13.stringFold$V(frame76.lambda$Fn176, srfi13.Lit0, this.f82s, new Object[]{start, end});
                    return frame76.ans;
                } catch (ClassCastException e22) {
                    throw new WrongType(e22, "make-string", 1, len);
                }
    ...
    public class frame7 extends ModuleBody {
        ...
        Object lambda19() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfor$Mneach, this.f83s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame81 extends ModuleBody {
        ...
        Object lambda185() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mncount, this.f84s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame82 extends ModuleBody {
        ...
        Object lambda187() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfill$Ex, this.f86s, this.maybe$Mnstart$Plend);
        }
        ...
        Object lambda188(Object start, Object end) {
            ...
            while (Scheme.numLss.apply2(i, start) == Boolean.FALSE) {
                Object obj = this.f86s;
                try {
                    CharSeq charSeq = (CharSeq) obj;
                    try {
                        int intValue = ((Number) i).intValue();
                        Object obj2 = this.f85char;
                        try {
    ...
    public class frame88 extends ModuleBody {
        ...
        Object lambda198(Object args) {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnkmp$Mnpartial$Mnsearch, this.f87s, args);
        }
    ...
    public class frame89 extends ModuleBody {
        ...
        Object lambda200() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnreverse, this.f88s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame8 extends ModuleBody {
        ...
        Object lambda21() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfor$Mneach$Mnindex, this.f89s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame90 extends ModuleBody {
        ...
        Object lambda202() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnreverse$Ex, this.f90s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame91 extends ModuleBody {
        ...
        Object lambda204() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mn$Grlist, this.f91s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame93 extends ModuleBody {
        ...
        Object lambda208() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntokenize, this.f92s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        Object lambda209(Object start, Object end) {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (x) {
                        try {
                            temp = srfi13.stringIndexRight$V(this.f92s, srfi13.loc$token$Mnchars.get(), new Object[]{start, i});
                        } catch (UnboundLocationException e) {
                    ...
                    try {
                        temp = srfi13.stringSkipRight$V(this.f92s, srfi13.loc$token$Mnchars.get(), new Object[]{start, temp});
                        if (temp != Boolean.FALSE) {
                            obj = this.f92s;
                            try {
                                CharSequence charSequence = (CharSequence) obj;
    ...
    public class frame94 extends ModuleBody {
            ...
            try {
                ...
                try {
                    if (numbers.isZero((Number) slen)) {
                        return misc.error$V("Cannot replicate empty (sub)string", new Object[]{srfi13.xsubstring, this.f93s, this.from, to, start, end});
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    srfi13.$PcMultispanRepcopy$Ex(ans, srfi13.Lit0, this.f93s, this.from, to, start, end);
                                    return ans;
                                } catch (ClassCastException e3222) {
        ...
        Object lambda211() {
            ...
            try {
                Object apply4 = Scheme.applyToArgs.apply4(srfi13.loc$check$Mnarg.get(), strings.string$Qu, this.f93s, srfi13.xsubstring);
                try {
        ...
        Object lambda212() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.xsubstring, this.f93s, lists.cdr.apply1(this.maybe$Mnto$Plstart$Plend));
        }
    ...
    public class frame95 extends ModuleBody {
        ...
        Object lambda221(Object sto, Object start, Object end) {
            ...
            try {
                ...
                if (!x) {
                    try {
                        if (numbers.isZero((Number) slen)) {
                            return misc.error$V("Cannot replicate empty (sub)string", new Object[]{srfi13.string$Mnxcopy$Ex, this.target, this.tstart, this.f94s, this.sfrom, sto, start, end});
                        } else if (Scheme.numEqu.apply2(srfi13.Lit1, slen) != Boolean.FALSE) {
                            r4 = this.target;
                            obj = this.f94s;
                            try {
                            ...
                            try {
                                ...
                                try {
                                    if (doubleValue != numbers.floor(LangObjType.coerceRealNum(r4)).doubleValue()) {
                                        return srfi13.$PcMultispanRepcopy$Ex(this.target, this.tstart, this.f94s, this.sfrom, sto, start, end);
                                    }
                                    obj = this.target;
                                    try {
                                        CharSequence charSequence = (CharSequence) obj;
        ...
        Object lambda218() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnxcopy$Ex, this.f94s, lists.cdr.apply1(this.maybe$Mnsto$Plstart$Plend));
        }
    ...
    public class frame9 extends ModuleBody {
        ...
        Object lambda23() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnevery, this.f96s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame extends ModuleBody {
        ...
        Object lambda2(Object end, Object args) {
            ...
            return misc.error$V("Illegal substring START/END spec", new Object[]{this.proc, this.start, end, this.f97s});
        }
        ...
        Object lambda1() {
            if (lists.isPair(this.args)) {
                ...
                if (x) {
                    ...
                    return misc.error$V("Illegal substring END spec", new Object[]{this.proc, end, this.f97s});
                }
    ...
    static {
        ...
        string$Mncopy = new ModuleMethod(moduleBody, ErrorMessages.ERROR_NO_CAMERA_PERMISSION, Lit52, -4095);
    ...
    public static Object stringParseStart$PlEnd(Object proc, Object s, Object args) {
        ...
        frame.proc = proc;
        frame.f97s = s;
        if (!strings.isString(frame.f97s)) {
            misc.error$V("Non-string value", new Object[]{frame.proc, frame.f97s});
        }
        Object obj = frame.f97s;
        try {
            ...
            if (lists.isPair(args)) {
                ...
                if (x) {
                    ...
                    return misc.error$V("Illegal substring START spec", new Object[]{frame.proc, frame.start, frame.f97s});
                }
    ...
    public static Object stringTake(Object s, Object n) {
        ...
        frame64.f68n = n;
        try {
            Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), strings.string$Qu, frame64.f69s, string$Mntake);
            try {
                Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), frame64.lambda$Fn151, frame64.f68n, string$Mntake);
                Object obj = frame64.f69s;
                try {
                    CharSequence charSequence = (CharSequence) obj;
                    Object obj2 = frame64.f68n;
                    try {
    ...
    public static Object stringTakeRight(Object s, Object n) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), frame65.lambda$Fn152, frame65.f70n, string$Mntake$Mnright);
                    try {
                        CharSequence charSequence = (CharSequence) s;
                        Object apply2 = AddOp.$Mn.apply2(Integer.valueOf(frame65.len), frame65.f70n);
                        try {
                    ...
                    e3.setLine("/u2/home/jis/ai2-kawa/gnu/kawa/slib/srfi13.scm", PointerIconCompat.TYPE_WAIT, 5);
                    throw e3;
                }
            } catch (ClassCastException e22) {
            ...
            e32.setLine("/u2/home/jis/ai2-kawa/gnu/kawa/slib/srfi13.scm", 1002, 3);
            throw e32;
        }
    }
    ...
    public static Object stringDrop(CharSequence s, Object n) {
        ...
        try {
            Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), frame66.lambda$Fn153, frame66.f71n, string$Mndrop);
            Object obj = frame66.f71n;
            try {
    ...
    public static Object stringDropRight(CharSequence s, Object n) {
        ...
        try {
            Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), frame67.lambda$Fn154, frame67.f72n, string$Mndrop$Mnright);
            Object apply2 = AddOp.$Mn.apply2(Integer.valueOf(frame67.len), frame67.f72n);
            try {
    ...
    public static Object stringFill$Ex$V(Object s, Object char_, Object[] argsArray) {
        ...
        frame82.f86s = s;
        frame82.f85char = char_;
        frame82.maybe$Mnstart$Plend = LList.makeList(argsArray, 0);
        try {
            Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), characters.char$Qu, frame82.f85char, string$Mnfill$Ex);
