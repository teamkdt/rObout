...
public class pregexp extends ModuleBody {
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda5loupOneOfChars(Object chars) {
            ...
            return this.staticLink.lambda3sub(lists.car.apply1(frame1.chars), this.f21i, this.sk, frame1.lambda$Fn13);
        }
        ...
        Object lambda10() {
            return Scheme.applyToArgs.apply2(this.sk, AddOp.$Pl.apply2(this.f21i, pregexp.Lit8));
        }
        ...
        public Object lambda6loupSeq(Object res, Object i) {
            ...
            return this.staticLink.lambda3sub(lists.car.apply1(frame2.res), i, frame2.lambda$Fn14, this.fk);
        }
        ...
        public Object lambda7loupOr(Object res) {
            ...
            return this.staticLink.lambda3sub(lists.car.apply1(frame3.res), this.f21i, frame3.lambda$Fn15, frame3.lambda$Fn16);
        }
        ...
        Object lambda12(Object i1) {
            ...
            try {
                lists.setCdr$Ex((Pair) assv, lists.cons(this.f21i, i1));
        ...
        public Object lambda8loupP(Object k, Object i) {
            ...
            frame4.f25k = k;
            frame4.f24i = i;
            if (Scheme.numLss.apply2(frame4.f25k, this.f22p) != Boolean.FALSE) {
                return this.staticLink.lambda3sub(this.re, frame4.f24i, frame4.lambda$Fn17, this.fk);
            }
            frame4.f26q = this.f23q != Boolean.FALSE ? AddOp.$Mn.apply2(this.f23q, this.f22p) : this.f23q;
            return frame4.lambda24loupQ(pregexp.Lit73, frame4.f24i);
        }
    }
    ...
    public class frame4 extends ModuleBody {
        ...
        public Object lambda24loupQ(Object k, Object i) {
            ...
            frame5.f27i = i;
            frame5.fk = frame5.fk;
            if (this.f26q == Boolean.FALSE ? this.f26q != Boolean.FALSE : Scheme.numGEq.apply2(frame5.f28k, this.f26q) != Boolean.FALSE) {
                return frame5.lambda26fk();
            }
            if (this.staticLink.maximal$Qu) {
                return this.staticLink.staticLink.lambda3sub(this.staticLink.re, frame5.f27i, frame5.lambda$Fn18, frame5.fk);
            }
            Boolean x = frame5.lambda26fk();
            return x == Boolean.FALSE ? this.staticLink.staticLink.lambda3sub(this.staticLink.re, frame5.f27i, frame5.lambda$Fn19, frame5.fk) : x;
        }
    }
    ...
    public class frame5 extends ModuleBody {
        ...
        public Object lambda26fk() {
            return Scheme.applyToArgs.apply2(this.staticLink.staticLink.sk, this.f27i);
        }
        ...
        Object lambda28(Object i1) {
            return this.staticLink.lambda24loupQ(AddOp.$Pl.apply2(this.f28k, pregexp.Lit8), i1);
        }
    }
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda3sub(Object re, Object i, Object sk, Object fk) {
            ...
            if (Scheme.isEqv.apply2(frame0.re$1, pregexp.Lit10) != Boolean.FALSE) {
                if (Scheme.numEqu.apply2(frame0.f21i, this.start) != Boolean.FALSE) {
                    return Scheme.applyToArgs.apply2(frame0.sk, frame0.f21i);
                }
                return Scheme.applyToArgs.apply1(frame0.fk);
            } else if (Scheme.isEqv.apply2(frame0.re$1, pregexp.Lit12) != Boolean.FALSE) {
                return Scheme.numGEq.apply2(frame0.f21i, this.f29n) != Boolean.FALSE ? Scheme.applyToArgs.apply2(frame0.sk, frame0.f21i) : Scheme.applyToArgs.apply1(frame0.fk);
            } else {
                ...
                if (Scheme.isEqv.apply2(frame0.re$1, pregexp.Lit26) != Boolean.FALSE) {
                    if (pregexp.isPregexpAtWordBoundary(this.f30s, frame0.f21i, this.f29n) != Boolean.FALSE) {
                        return Scheme.applyToArgs.apply2(frame0.sk, frame0.f21i);
                    }
                    return Scheme.applyToArgs.apply1(frame0.fk);
                    ...
                    if (x ? Scheme.numLss.apply2(frame0.f21i, this.f29n) != Boolean.FALSE : x) {
                        ...
                        try {
                            ...
                            obj = frame0.f21i;
                            try {
                                return procedure.apply2(Char.make(strings.stringRef(charSequence, ((Number) obj).intValue())), frame0.re$1) != Boolean.FALSE ? Scheme.applyToArgs.apply2(frame0.sk, AddOp.$Pl.apply2(frame0.f21i, pregexp.Lit8)) : Scheme.applyToArgs.apply1(frame0.fk);
                            } catch (ClassCastException e) {
                    ...
                    x = (lists.isPair(frame0.re$1) + 1) & 1;
                    if (x ? Scheme.numLss.apply2(frame0.f21i, this.f29n) != Boolean.FALSE : x) {
                        obj2 = this.f30s;
                        try {
                            charSequence = (CharSequence) obj2;
                            obj = frame0.f21i;
                            try {
                                if (pregexp.isPregexpCheckIfInCharClass(Char.make(strings.stringRef(charSequence, ((Number) obj).intValue())), frame0.re$1) != Boolean.FALSE) {
                                    return Scheme.applyToArgs.apply2(frame0.sk, AddOp.$Pl.apply2(frame0.f21i, pregexp.Lit8));
                                }
                                return Scheme.applyToArgs.apply1(frame0.fk);
                    ...
                    Boolean x2;
                    Object x3 = lists.isPair(frame0.re$1);
                    if (x3 != null) {
                        x2 = Scheme.isEqv.apply2(lists.car.apply1(frame0.re$1), pregexp.Lit83);
                        if (x2 == Boolean.FALSE) {
                        }
                    } else {
                        if (x3 != null) {
                        }
                        if (lists.isPair(frame0.re$1)) {
                            Object tmp = lists.car.apply1(frame0.re$1);
                            if (Scheme.isEqv.apply2(tmp, pregexp.Lit83) != Boolean.FALSE) {
                                if (Scheme.numGEq.apply2(frame0.f21i, this.f29n) != Boolean.FALSE) {
                                    return Scheme.applyToArgs.apply1(frame0.fk);
                                }
                                ...
                                return frame0.lambda5loupOneOfChars(lists.cdr.apply1(frame0.re$1));
                            } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit17) != Boolean.FALSE) {
                                if (Scheme.numGEq.apply2(frame0.f21i, this.f29n) != Boolean.FALSE) {
                                    return Scheme.applyToArgs.apply1(frame0.fk);
                                }
                                return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f21i, frame0.lambda$Fn2, frame0.lambda$Fn3);
                            } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit5) != Boolean.FALSE) {
                                return frame0.lambda6loupSeq(lists.cdr.apply1(frame0.re$1), frame0.f21i);
                            } else {
                                if (Scheme.isEqv.apply2(tmp, pregexp.Lit4) != Boolean.FALSE) {
                                    return frame0.lambda7loupOr(lists.cdr.apply1(frame0.re$1));
                                }
                                if (Scheme.isEqv.apply2(tmp, pregexp.Lit20) != Boolean.FALSE) {
                                    Boolean backref;
                                    Boolean c = pregexp.pregexpListRef(this.backrefs, lists.cadr.apply1(frame0.re$1));
                                    if (c != Boolean.FALSE) {
                                        backref = lists.cdr.apply1(c);
                                    } else {
                                        pregexp.pregexpError$V(new Object[]{pregexp.Lit101, pregexp.Lit102, frame0.re$1});
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            try {
                                                return pregexp.pregexpStringMatch(strings.substring(charSequence, intValue, ((Number) obj).intValue()), this.f30s, frame0.f21i, this.f29n, frame0.lambda$Fn4, frame0.fk);
                                    ...
                                    return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f21i, frame0.lambda$Fn5, frame0.fk);
                                } else {
                                    if (Scheme.isEqv.apply2(tmp, pregexp.Lit103) != Boolean.FALSE) {
                                        return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f21i, this.identity, pregexp.lambda$Fn6) != Boolean.FALSE ? Scheme.applyToArgs.apply2(frame0.sk, frame0.f21i) : Scheme.applyToArgs.apply1(frame0.fk);
                                    } else {
                                        if (Scheme.isEqv.apply2(tmp, pregexp.Lit104) != Boolean.FALSE) {
                                            return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f21i, this.identity, pregexp.lambda$Fn7) != Boolean.FALSE ? Scheme.applyToArgs.apply1(frame0.fk) : Scheme.applyToArgs.apply2(frame0.sk, frame0.f21i);
                                        } else {
                                            Object n$Mnactual;
                                            Object sn$Mnactual;
                                            Boolean found$Mnit$Qu;
                                            if (Scheme.isEqv.apply2(tmp, pregexp.Lit105) != Boolean.FALSE) {
                                                n$Mnactual = this.f29n;
                                                sn$Mnactual = this.sn;
                                                this.f29n = frame0.f21i;
                                                this.sn = frame0.f21i;
                                                found$Mnit$Qu = lambda3sub(LList.list4(pregexp.Lit5, pregexp.Lit106, lists.cadr.apply1(frame0.re$1), pregexp.Lit12), pregexp.Lit73, this.identity, pregexp.lambda$Fn8);
                                                this.f29n = n$Mnactual;
                                                this.sn = sn$Mnactual;
                                                return found$Mnit$Qu != Boolean.FALSE ? Scheme.applyToArgs.apply2(frame0.sk, frame0.f21i) : Scheme.applyToArgs.apply1(frame0.fk);
                                            } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit107) != Boolean.FALSE) {
                                                n$Mnactual = this.f29n;
                                                sn$Mnactual = this.sn;
                                                this.f29n = frame0.f21i;
                                                this.sn = frame0.f21i;
                                                found$Mnit$Qu = lambda3sub(LList.list4(pregexp.Lit5, pregexp.Lit108, lists.cadr.apply1(frame0.re$1), pregexp.Lit12), pregexp.Lit73, this.identity, pregexp.lambda$Fn9);
                                                this.f29n = n$Mnactual;
                                                this.sn = sn$Mnactual;
                                                return found$Mnit$Qu != Boolean.FALSE ? Scheme.applyToArgs.apply1(frame0.fk) : Scheme.applyToArgs.apply2(frame0.sk, frame0.f21i);
                                            } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit109) != Boolean.FALSE) {
                                                found$Mnit$Qu = lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f21i, this.identity, pregexp.lambda$Fn10);
                                                if (found$Mnit$Qu != Boolean.FALSE) {
                                                    return Scheme.applyToArgs.apply2(frame0.sk, found$Mnit$Qu);
                                                }
                                                return Scheme.applyToArgs.apply1(frame0.fk);
                                            } else {
                                                ...
                                                if (x2 == Boolean.FALSE ? Scheme.isEqv.apply2(tmp, pregexp.Lit61) != Boolean.FALSE : x2 != Boolean.FALSE) {
                                                    frame0.old = this.case$Mnsensitive$Qu;
                                                    this.case$Mnsensitive$Qu = Scheme.isEqv.apply2(lists.car.apply1(frame0.re$1), pregexp.Lit60);
                                                    return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f21i, frame0.lambda$Fn11, frame0.lambda$Fn12);
                                                } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit68) != Boolean.FALSE) {
                                                    obj2 = lists.cadr.apply1(frame0.re$1);
                                                    try {
                                                        boolean z;
                                                        frame0.maximal$Qu = ((obj2 != Boolean.FALSE ? 1 : 0) + 1) & 1;
                                                        frame0.f22p = lists.caddr.apply1(frame0.re$1);
                                                        frame0.f23q = lists.cadddr.apply1(frame0.re$1);
                                                        if (frame0.maximal$Qu) {
                                                            obj2 = frame0.f23q;
                                                            try {
                                                                int i2;
                                                        ...
                                                        z = frame0.maximal$Qu;
                                                        frame0.could$Mnloop$Mninfinitely$Qu = z;
                                                        frame0.re = lists.car.apply1(lists.cddddr.apply1(frame0.re$1));
                                                        return frame0.lambda8loupP(pregexp.Lit73, frame0.f21i);
                        ...
                        } else if (Scheme.numGEq.apply2(frame0.f21i, this.f29n) != Boolean.FALSE) {
                            return Scheme.applyToArgs.apply1(frame0.fk);
                        } else {
                            return pregexp.pregexpError$V(new Object[]{pregexp.Lit101});
                        }
                    ...
                    try {
                        ...
                        try {
                            ...
                            x2 = c$Ls.apply2(lists.cadr.apply1(frame0.re$1), Char.make(c2));
                            if (x2 == Boolean.FALSE ? x2 != Boolean.FALSE : c$Ls.apply2(Char.make(c2), lists.caddr.apply1(frame0.re$1)) != Boolean.FALSE) {
                                return Scheme.applyToArgs.apply2(frame0.sk, AddOp.$Pl.apply2(frame0.f21i, pregexp.Lit8));
                            }
                            return Scheme.applyToArgs.apply1(frame0.fk);
                ...
                } else if (pregexp.isPregexpAtWordBoundary(this.f30s, frame0.f21i, this.f29n) != Boolean.FALSE) {
                    return Scheme.applyToArgs.apply1(frame0.fk);
                } else {
                    return Scheme.applyToArgs.apply2(frame0.sk, frame0.f21i);
                }
    ...
    public static Object pregexpMatchPositionsAux(Object re, Object s, Object sn, Object start, Object n, Object i) {
        ...
        frame.start = start;
        frame.f29n = n;
        Procedure procedure = frame.identity;
        Object pregexpMakeBackrefList = pregexpMakeBackrefList(re);
        frame.case$Mnsensitive$Qu = Boolean.TRUE;
        frame.backrefs = pregexpMakeBackrefList;
        frame.identity = procedure;
        frame.lambda3sub(re, i, frame.identity, lambda$Fn1);
        Object arg0 = frame.backrefs;
