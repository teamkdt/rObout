...
public class testing extends ModuleBody {
    ...
    public class frame1 extends ModuleBody {
        ...
        Object lambda9() {
            return ((Procedure) testing.test$Mnrunner$Mncurrent).apply1(this.f102r);
        }
    ...
    public class frame2 extends ModuleBody {
        ...
        boolean lambda12(Object runner) {
            this.f103i = AddOp.$Pl.apply2(this.f103i, testing.Lit13);
            Object apply2 = Scheme.numGEq.apply2(this.f103i, this.f104n);
            try {
                boolean x = ((Boolean) apply2).booleanValue();
                return x ? ((Boolean) Scheme.numLss.apply2(this.f103i, AddOp.$Pl.apply2(this.f104n, this.count))).booleanValue() : x;
            } catch (ClassCastException e) {
                throw new WrongType(e, "x", -2, apply2);
            }
        }
    ...
    public static void testResultRemove(Object runner, Object pname) {
        ...
        try {
            Object alist = testResultAlist((test$Mnrunner) runner);
            frame.f105p = lists.assq(pname, alist);
            if (frame.f105p != Boolean.FALSE) {
                try {
                    testResultAlist$Ex((test$Mnrunner) runner, frame.lambda4loop(alist));
                } catch (ClassCastException e) {
                    throw new WrongType(e, "test-result-alist!", 0, runner);
                }
            }
    ...
    public static Object testApply$V(Object first, Object[] argsArray) {
        ...
        frame1.first = first;
        frame1.rest = LList.makeList(argsArray, 0);
            ...
            try {
                ...
                try {
                    ...
                    if (run$Mnlist == Boolean.TRUE) {
                        list1 = LList.list1(frame1.first);
                    } else {
                        list1 = lists.cons(frame1.first, run$Mnlist);
                    }
                    $PcTestRunnerRunList$Ex(test_mnrunner, list1);
        ...
        Object obj = frame1.f102r;
        try {
            return procedure.apply2(testRunnerOnFinal((test$Mnrunner) obj), frame1.f102r);
    ...
    public static Procedure $PcTestMatchAll$V(Object[] argsArray) {
        ...
        frame3.pred$Mnlist = LList.makeList(argsArray, 0);
        return frame3.lambda$Fn12;
    }

    public static Procedure $PcTestMatchAny$V(Object[] argsArray) {
        frame4 frame4 = new frame4();
        frame4.pred$Mnlist = LList.makeList(argsArray, 0);
        return frame4.lambda$Fn13;
    }
